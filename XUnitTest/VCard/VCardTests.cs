...
public class VCardTests
{
    ...
    public void Write_BasicContact_ContainsRequiredFields()
    {
        ...
        contact.Phones.Add(new Phone { Number = "+86-10-12345678", Type = "WORK" });
        contact.Emails.Add(new Email { Address = "jane@newlife.org", Type = "WORK" });
    ...
    public void WriteAll_MultipleContacts_AllInFile()
    {
        ...
        {
            new Contact { FullName = "Alice" },
            new Contact { FullName = "Bob" },
        };
    ...
    public void RoundTrip_WriteAndRead()
    {
        ...
        original.Phones.Add(new Phone { Number = "1234567890", Type = "CELL" });
        original.Emails.Add(new Email { Address = "rt@test.com" });
    ...
    public void Integration_WriteFile_ThenReadFile()
    {
        ...
        var contacts = new List<Contact>
        {
            ...
            new Contact { FullName = "李四" },
        };
        contacts[0].Phones.Add(new Phone { Number = "+86-138-0000-0001", Type = "CELL" });
        contacts[0].Emails.Add(new Email { Address = "zhangsan@newlife.org", Type = "WORK" });
        contacts[0].Addresses.Add(new Address
        {
            Street = "中关村大街 1 号",
            City = "北京",
            Country = "中国",
