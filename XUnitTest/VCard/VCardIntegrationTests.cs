...
namespace XUnitTest.VCard;

/// <summary>VCard 格式集成测试</summary>
public class VCardIntegrationTests : IntegrationTestBase
{
    ...
    public void VCard_ComplexWriteAndRead()
    {
        ...
        contact1.Phones.Add(new Phone { Number = "+86-138-0000-0001", Type = "CELL" });
        contact1.Phones.Add(new Phone { Number = "+86-010-12345678", Type = "WORK" });
        contact1.Emails.Add(new Email { Address = "zhangsan@example.com", Type = "WORK" });
        contact1.Emails.Add(new Email { Address = "zhangsan@personal.com", Type = "HOME" });
        contact1.Addresses.Add(new Address
        {
            Street = "中关村大街1号",
            City = "北京",
            Region = "北京",
        ...
        contact2.Phones.Add(new Phone { Number = "+86-139-0000-0002", Type = "CELL" });
        contact2.Emails.Add(new Email { Address = "lisi@example.com", Type = "WORK" });
