...
public class ExcelXlsxTests : IntegrationTestBase
{
    ...
    public void Excel_Xlsx_ComplexWriteAndRead()
    {
        ...
        using (var w = new ExcelWriter(path))
        {
            ...
            w.AddConditionalFormat("员工表", "E2:E6", ConditionalFormatValues.GreaterThan, "10000", "92D050");
            ...
            w.WriteDataTable("销售统计", dt, NewLife.Office.Excel.CellFormat.Header);
            w.AddConditionalFormat("销售统计", "B2:B5", ConditionalFormatValues.DataBar, null, "4472C4");
